...
def predict_age_gender_race(save_prediction_at, imgs_path = 'cropped_faces/'):
    ...
    model_fair_7 = torchvision.models.resnet50(pretrained=True)
    model_fair_7.fc = nn.Linear(model_fair_7.fc.in_features, 18)
    #model_fair_7.load_state_dict(torch.load('fairface_res1.pth'))
    model_fair_7 = torch.load('fairface_res1.pth')
    #model_fair_7.load_state_dict(torch.load('fairface_alldata_4race_20191111.pt'))
